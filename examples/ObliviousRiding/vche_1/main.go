...
func obliviousRiding() {
	...
	evaluatorPlaintextEncoder := vche_1.NewEncoderPlaintext(params, riderSk.K)
	...
	driversVerif := make([]*vche_1.TaggedPoly, nbDrivers)
	for i := 0; i < nbDrivers; i++ {
		...
		driversPlaintexts[i] = vche_1.NewPlaintext(params)
