...
func init() {
	...
	encoder = vche_2.NewEncoder(params, riderSk.K, riderSk.Alpha, true)
	...
	encoderPlaintext = vche_2.NewEncoderPlaintextCFPRF(params, riderSk.K)
...
func benchEncVerif(riderTags []vche.Tag, driversTags [][]vche.Tag, b *testing.B) (*vche_2.VerifPlaintext, []*vche_2.VerifPlaintext) {
	riderVerif := vche_2.NewVerifPlaintext(params)
	driversVerif := make([]*vche_2.VerifPlaintext, len(driversTags))
	for i := range driversVerif {
		driversVerif[i] = vche_2.NewVerifPlaintext(params)
	}
...
func benchVerif(riderVerif *vche_2.VerifPlaintext, driversVerif []*vche_2.VerifPlaintext, b *testing.B) *vche_2.Poly {
	var resVerifPlaintext *vche_2.VerifPlaintext
